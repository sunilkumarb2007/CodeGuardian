...
class EvidenceEvent(Base):
    ...
    event_metadata = Column('metadata', JSONB, nullable=False)
...
class FailureTrace(Base):
    ...
    correlation_method = Column(JSONB, nullable=False)
    created_at = Column(TIMESTAMP, nullable=False)
...
class FailureTraceNode(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, nullable=False)
    failure_trace_id = Column(UUID(as_uuid=True), ForeignKey('failure_traces.id'), nullable=False)
...
class FailureTraceEdge(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, nullable=False)
    failure_trace_id = Column(UUID(as_uuid=True), ForeignKey('failure_traces.id'), nullable=False)
    from_node_id = Column(UUID(as_uuid=True), ForeignKey('failure_trace_nodes.id'), nullable=False)
    to_node_id = Column(UUID(as_uuid=True), ForeignKey('failure_trace_nodes.id'), nullable=False)
...
class Investigation(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, nullable=False)
    incident_id = Column(UUID(as_uuid=True), ForeignKey('incidents.id'), nullable=False)
    failure_trace_id = Column(UUID(as_uuid=True), ForeignKey('failure_traces.id'), nullable=True)
    model_provider = Column(String(50), nullable=True)
    model_name = Column(String(100), nullable=True)
    investigation_type = Column(String(50), nullable=False)
    root_cause = Column(Text, nullable=True)
    explanation = Column(Text, nullable=True)
    affected_files = Column(JSONB, nullable=False)
    affected_lines = Column(JSONB, nullable=False)
...
class FailureMemory(Base):
    ...
    pull_request_history = Column(JSONB, nullable=True)
...
class MemoryMatch(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, nullable=False)
    incident_id = Column(UUID(as_uuid=True), ForeignKey('incidents.id'), nullable=False)
    memory_id = Column(UUID(as_uuid=True), ForeignKey('failure_memories.id'), nullable=False)
...
class Patch(Base):
    ...
    memory_match_id = Column(UUID(as_uuid=True), ForeignKey('memory_matches.id'), nullable=True)
...
class RepairAttempt(Base):
    ...
    id = Column(UUID(as_uuid=True), primary_key=True, nullable=False)
    incident_id = Column(UUID(as_uuid=True), ForeignKey('incidents.id'), nullable=False)
    patch_id = Column(UUID(as_uuid=True), ForeignKey('patches.id'), nullable=True)
    validation_run_id = Column(UUID(as_uuid=True), ForeignKey('validation_runs.id'), nullable=True)
...
class IncidentStatusHistory(Base):
    ...
    status_metadata = Column('metadata', JSONB, nullable=False)
    created_at = Column(TIMESTAMP, nullable=False)
...
class DemoRun(Base):
    ...
    presentation_sequence = Column(JSONB, nullable=True)
...
class DemoEvent(Base):
    ...
    related_file = Column(String(300), nullable=True)
