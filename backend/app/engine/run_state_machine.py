...
VALID_TRANSITIONS = {
    ...
    RunState.INVESTIGATION_SCHEMA_ERROR: [RunState.INVESTIGATION_RUNNING, RunState.REPAIR_EXHAUSTED],
    RunState.PATCH_LANGUAGE_MISMATCH: [RunState.INVESTIGATION_RUNNING, RunState.REPAIR_EXHAUSTED],
